...
public class InvestimentoController {
    ...
    @PostMapping("/chiudiInvestimento/{idInvestimento}")
    public ResponseEntity<Investimento> chiudiInvestimento(@PathVariable int idInvestimento) {
        return ResponseEntity.ok(this.investimentoService.chiudiInvestimento(idInvestimento));
